...
# https://nessus-quantumcrypto.chals.io/

'''
Quantum Key Distribution Test
You must send a POST request with 1024 qbit states and basis to the service in order to get a response.

JSON Request Data Format Example:
{"state_list":[[1.0,0.0],[0.7071067811865475,-0.7071067811865475],...],
 "basis_list":["X", "H", "X", "X",....]
}
		
URL
http:///quantum_key
Server Simulation Code Snippet
'''
import numpy as np
import random
